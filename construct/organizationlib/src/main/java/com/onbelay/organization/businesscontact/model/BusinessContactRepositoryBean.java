 ...
 * All Rights Reserved
*/
package com.onbelay.organization.businesscontact.model;
...
import com.onbelay.organization.businesscontact.repository.BusinessContactRepository;
...
public class BusinessContactRepositoryBean extends BaseRepository<BusinessContact> implements BusinessContactRepository {
	...
	public BusinessContact findByEmail(String email) {
		return executeSingleResultQuery(FIND_BY_EMAIL, "email", email);
	}
